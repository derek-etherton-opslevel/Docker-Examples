...
- **Rootless containers**: Runs as a non-root user for improved security with Podman
...
> **Note**: Rootless Podman requires ports above 1024 by default. The default ports used here (8080, 5432, 5672, 15672) are all compatible with rootless operation.
